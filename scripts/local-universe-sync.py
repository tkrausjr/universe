...
def main():
    ...
    with tempfile.TemporaryDirectory() as dir_path, \
        ...
        def handle_package(opts):
            ...
            try:
                ...
                for name in enumerate_docker_images(path):
                    ...
                    imagename = format_image_name('localhost:5000', name)
                    dockerimages.append(imagename)
        ...
        dockerimage_ouputfile(dockerimages)
...
# TK Addition 9 Lines below to provide a text doc with Images needed for upload.
############################
def dockerimage_ouputfile(dockerimages):
    print ('TK - dockerimage_ouputfile Function')
    fileobj = open('dockerimages.txt', 'wt')
    for image in dockerimages:
        # separator = ' '
        # imagename=separator.join(image)
